...
def plot_snake(gameWindow, color, snk_list, snake_size):
    ...
    for x,y in snk_list:
        # print(x,y)
        new_var = pygame.draw.rect(gameWindow, color, [x, y, snake_size, snake_size])
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            if abs(snake_x - food_x)<8 and abs(snake_y - food_y)<8:    #ye food aur snake ke centers ke beech kitna distance hoga taki snake food ko kha le                                                             
                score +=10                                               #abs absolute value ke liye hai
            ...
            gameWindow.fill(white)
            text_screen("Score: " + str(score) + "  Hiscore: " + str(hiscore), red, 5, 5)      #score screen
            pygame.draw.rect(gameWindow, red, [food_x, food_y, snake_size, snake_size])   #isko bhi white game window ke code ke neeche hi rakhna hai vrna show nhi krega 
